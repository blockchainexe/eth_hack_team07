...
contract ControlledByServiceProvider is Ownable {
  ...
  modifier onlyServiceProvider() {
    require(isServiceProvider[msg.sender]);
    _;
  }
 ...
 */
contract BurnableToken is BasicToken, ControlledByServiceProvider {
   ...
   */
  function burn(address _address,  uint256 _value) onlyServiceProvider() public {
...
// File: contracts/DQNPoint.sol

contract DQNPoint is MintableToken, BurnableToken {
    string public name;
